...
- 左側色條提示："內容來自總部範本，儲存後為本館自訂"（單側 Border Info Item 樣式，Color/Neutral/500 文字）
- 卡片內建 Footer："取消" / "儲存"
```
...
- 無。所有色值（`#f6fafd`、`#b0b0b0`、`#ffffff`、`#d1d1d1`、`#e1e1e0`、`#6d6d6d`）皆已對照到 `tokens.md` 既有 token。`icons/document` 本機已存在，不需補匯出。
