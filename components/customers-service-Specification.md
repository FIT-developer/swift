...
│   └── Texts md Bold → "客服"  20px  SemiBold 600  #454545
└── Texts sm → "平日 09:00~18:00"  12px  Regular  #454545  (x:120)
```
...
| 變化 | 值 | Token |
|---|---|---|
| Title 的 Texts 背景 | `#e1e1e0` | `Color/Neutral/100` |
| 服務時段 Texts 背景 | `#e1e1e0` | `Color/Neutral/100` |
...
└── Frame 6 — 聯絡卡片 (216×344px, y:51)
    ├── cornerRadius 8, padding 12px, stroke #d1d1d1
...
所有列寬 192px，高 22px，文字使用 `Texts / base (16px Regular, #454545)`：
...
└── Texts sm → "service@bbnet.gmail.com"  12px  Regular  #454545  (x:28)
```
...
| 元素 | 色值 | Token |
|---|---|---|
| 文字（所有） | `#454545` | `Color/Neutral/800` |
| Hover 背景 | `#e1e1e0` | `Color/Neutral/100` |
...
5. **hover 效果**：`hover:bg-[#e1e1e0] cursor-pointer`
